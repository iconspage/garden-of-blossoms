...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Palm Garden Resort" },
      { property: "og:site_name", content: "Palm Garden Resort" },
      { property: "og:title", content: "Palm Garden Resort — Kaase, Kumasi" },
      { property: "og:description", content: "A tranquil garden resort in Kaase, Kumasi. Pool, boat rides, fish feeding, café, restaurant & event spaces." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Palm Garden Resort — Kaase, Kumasi" },
      { name: "twitter:description", content: "A tranquil garden resort in Kaase, Kumasi. Pool, boat rides, fish feeding, café, restaurant & event spaces." },
